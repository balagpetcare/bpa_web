...
import type { SpayOfferGalleryImage } from '@/lib/api/spay-neuter';
import { resolveMediaUrl } from '@/lib/utils/format';

interface Props {
  items: SpayOfferGalleryImage[];
  title: string;
}

function getUrl(item: SpayOfferGalleryImage): string {
  return resolveMediaUrl(item.url) ?? '';
}

export default function SpayOfferGallery({ items, title }: Props) {
